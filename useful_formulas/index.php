...
if($_REQUEST['id3'])
{
				...
				print "<form action='$_SERVER[PHP_SELF]' method='POST' >";
				print "<strong><h1><center>Conversion of µg to pmol</center></h1></strong>";
					print "	<table align='center' BGCOLOR='#ddddff' width='' border='0'>";
					print "  <tr>";
					print "  </tr>";
					print "  <tr>";
...
print "  </tr>";
print "<tr>";
print "<td>pmol of ssDNA = µg (of ssDNA) x 3030/Nbp</td>";
print "  </tr>";
print "</table>";
...
if($_REQUEST['id4'])
{
				...
				print "<form action='$_SERVER[PHP_SELF]' method='POST'>";
				print "<strong><h1><center>Conversion of pmol to µg</center></h1></strong>";
					print "	<table align='center' BGCOLOR='#ddddff' width='' border='0'>";
					print "  <tr>";
					print "  </tr>";
					print "  <tr>";
					...
					print "   <td align='center'><font size='4'>$result  µg</font></td>";}
					print "  </tr>";
					print "<tr>";
					print "    <td align='right'></td>";
					print "  </tr>";
...
print	"<table align='center'  border='0' cellspacing='10' cellpadding='0'>";
print "<tr>";
print "<td>pmol of ssRNA = µg (of ssRNA) x 2914/Nbp</td>";
print "  </tr>";
print "</table>";
